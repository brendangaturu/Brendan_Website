...
from .views import HomePageView, WebdesignPageView, WebdevelopmentPageView, MobileDevelopmentPageView, DigitalmarketingPageView, ContentwritingPageView, CreativedesignPageView, emailview
